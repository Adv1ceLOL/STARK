...
_sage_const_2 = Integer(2); _sage_const_31 = Integer(31); _sage_const_24 = Integer(24); _sage_const_1 = Integer(1); _sage_const_16 = Integer(16); _sage_const_4 = Integer(4); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3); _sage_const_500 = Integer(500); _sage_const_100 = Integer(100); _sage_const_1p075 = RealNumber('1.075'); _sage_const_6 = Integer(6); _sage_const_2p0 = RealNumber('2.0'); _sage_const_10 = Integer(10); _sage_const_3p0 = RealNumber('3.0'); _sage_const_160 = Integer(160); _sage_const_62 = Integer(62); _sage_const_51 = Integer(51); _sage_const_38 = Integer(38); _sage_const_23 = Integer(23); _sage_const_13 = Integer(13); _sage_const_12 = Integer(12); _sage_const_30 = Integer(30); _sage_const_5 = Integer(5); _sage_const_7 = Integer(7)# Remark: This script contains functionality for GF(2^n), but currently works only over GF(p)! A few small adaptations are needed for GF(2^n).
...
###########################################################################
#p = 2**31 -1 
p = _sage_const_2 **_sage_const_31  - _sage_const_2 **_sage_const_24  + _sage_const_1 
n = len(p.bits()) # bit
t = _sage_const_16  
R_F_FIXED = _sage_const_4 
R_P_FIXED = _sage_const_1 
...
def algorithm_2(M, NUM_CELLS):
    ...
    I_powerset = list(powerset(I))[_sage_const_1 :]
